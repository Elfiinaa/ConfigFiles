...
### Windows:
Use the steps the previous section but:
 - Instead of step 2, Extract [this zip file](wow/WarpIPScanner_Win-v23.11.15.zip) and open the WarpIPEndpointScanner.bat to start the scanner.
